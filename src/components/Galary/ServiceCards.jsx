...
const ServiceCards = ({ icon, title }) => {
  return (
    <div className="text-center p-8 space-y-4 bg-slate-100 border-2 border-secondary hover:bg-secondary hover:text-black hover:bg-slate-400 transition duration-300 ease-in-out rounded-md cursor-pointer">
      {icon}
